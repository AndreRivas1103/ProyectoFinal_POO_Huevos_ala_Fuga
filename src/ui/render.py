...
class Render:
    def __init__(self):
        self.CREMA = (255, 253, 208)
        self.MARRON_CLARO = (210, 180, 140)
        self.MARRON_OSCURO = (139, 69, 19)  
        self.ROJO_COCINA = (178, 34, 34)
        self.VERDE_COCINA = (0, 128, 0)
        self.AZUL_COCINA = (70, 130, 180)
        self.AMARILLO_COCINA = (255, 215, 0)

    def obtener_nombre_nivel(self, nivel):
        nombres_niveles = {
            1: "Cocina Inicial",
            2: "Zona de Cocción", 
            3: "Gran Escape"
    ...
    def dibujar_menu(self, pantalla, mostrar_puntuaciones, puntuaciones):
        pantalla.fill(self.CREMA)
        ...
        for i in range(5):
            x = 100 + i * 150
            pygame.draw.rect(pantalla, self.MARRON_OSCURO, (x, 50, 80, 10))
            if i % 3 == 0:
                pygame.draw.circle(pantalla, self.MARRON_CLARO, (x + 40, 100), 20)
                pygame.draw.rect(pantalla, self.MARRON_CLARO, (x + 35, 100, 10, 40))
            elif i % 3 == 1:
                pygame.draw.circle(pantalla, (100, 100, 100), (x + 40, 110), 25)
                pygame.draw.rect(pantalla, self.MARRON_CLARO, (x + 60, 90, 15, 10))
            else:
                pygame.draw.rect(pantalla, self.MARRON_CLARO, (x + 30, 80, 20, 50))
                pygame.draw.rect(pantalla, self.MARRON_CLARO, (x + 25, 80, 30, 10))
        
        if mostrar_puntuaciones:
            pygame.draw.rect(pantalla, BLANCO, (ANCHO_PANTALLA//2 - 250, 180, 500, 300))
            pygame.draw.rect(pantalla, self.MARRON_OSCURO, (ANCHO_PANTALLA//2 - 250, 180, 500, 300), 5)
            fuente_titulo = pygame.font.SysFont("arial", 40, bold=True)
            titulo = fuente_titulo.render("MEJORES TIEMPOS", True, self.MARRON_OSCURO)
            pantalla.blit(titulo, (ANCHO_PANTALLA//2 - titulo.get_width()//2, 200))
            pygame.draw.line(pantalla, self.MARRON_OSCURO, 
                           (ANCHO_PANTALLA//2 - 200, 245), 
                           (ANCHO_PANTALLA//2 + 200, 245), 3)
            fuente_lista = pygame.font.SysFont("arial", 24)
            
            if not puntuaciones:
                mensaje = fuente_lista.render("Aún no hay puntuaciones registradas", True, self.MARRON_OSCURO)
                pantalla.blit(mensaje, (ANCHO_PANTALLA//2 - mensaje.get_width()//2, 300))
            else:
                encabezado = fuente_lista.render("Nombre         Nivel         Tiempo", True, self.MARRON_OSCURO)
                pantalla.blit(encabezado, (ANCHO_PANTALLA//2 - 200, 260))
                for i, p in enumerate(puntuaciones[:5]):
                    color_fila = self.MARRON_OSCURO
            ...
            pygame.draw.rect(pantalla, self.MARRON_CLARO, boton_volver, border_radius=10)
            pygame.draw.rect(pantalla, self.MARRON_OSCURO, boton_volver, 2, border_radius=10)
            fuente_boton = pygame.font.SysFont("arial", 22)
            volver = fuente_boton.render("Presiona P para volver", True, self.MARRON_OSCURO)
            pantalla.blit(volver, (boton_volver.centerx - volver.get_width()//2, 
                                   boton_volver.centery - volver.get_height()//2))
        else:
            pygame.draw.rect(pantalla, self.MARRON_CLARO, (ANCHO_PANTALLA//2 - 300, 120, 600, 200), border_radius=15)
            pygame.draw.rect(pantalla, self.MARRON_OSCURO, (ANCHO_PANTALLA//2 - 300, 120, 600, 200), 5, border_radius=15)
            
            fuente_titulo = pygame.font.SysFont("arial", 60, bold=True)
            titulo = fuente_titulo.render("HUEVOS A LA FUGA", True, self.MARRON_OSCURO)
            pantalla.blit(titulo, (ANCHO_PANTALLA//2 - titulo.get_width()//2, 150))
            
            fuente_subtitulo = pygame.font.SysFont("arial", 24, italic=True)
            subtitulo = fuente_subtitulo.render("¡Ayuda al huevo a escapar de la cocina!", True, self.MARRON_OSCURO)
        ...
        pygame.draw.rect(pantalla, self.MARRON_CLARO, boton_jugar, border_radius=10)
        pygame.draw.rect(pantalla, self.MARRON_OSCURO, boton_jugar, 2, border_radius=10)
        
        instruccion1 = fuente_botones.render("Presiona ENTER para jugar", True, self.MARRON_OSCURO)
        ...
        pygame.draw.rect(pantalla, self.MARRON_CLARO, boton_puntuaciones, border_radius=10)
        pygame.draw.rect(pantalla, self.MARRON_OSCURO, boton_puntuaciones, 2, border_radius=10)
        
        instruccion2 = fuente_botones.render("Presiona P para puntuaciones", True, self.MARRON_OSCURO)
    ...
    def dibujar_pausa(self, pantalla):
        ...
        pygame.draw.rect(pantalla, self.MARRON_OSCURO, (ANCHO_PANTALLA//2 - 200, 150, 400, 300), 5, border_radius=15)
        fuente_titulo = pygame.font.SysFont("arial", 48, bold=True)
        titulo = fuente_titulo.render("PAUSA", True, self.MARRON_OSCURO)
        ...
        pygame.draw.rect(pantalla, self.MARRON_CLARO, boton_continuar, border_radius=10)
        pygame.draw.rect(pantalla, self.MARRON_OSCURO, boton_continuar, 2, border_radius=10)
        
        instruccion1 = fuente_botones.render("ESC - Continuar", True, self.MARRON_OSCURO)
        ...
        pygame.draw.rect(pantalla, self.MARRON_CLARO, boton_salir, border_radius=10)
        pygame.draw.rect(pantalla, self.MARRON_OSCURO, boton_salir, 2, border_radius=10)
        
        instruccion2 = fuente_botones.render("Q - Salir al menú", True, self.MARRON_OSCURO)
    ...
    def dibujar_game_over(self, pantalla, nivel_actual):
        ...
        pygame.draw.rect(pantalla, self.MARRON_CLARO, (ANCHO_PANTALLA//2 + 200, ALTO_PANTALLA//2 - 40, 150, 80), border_radius=10)
        ...
        pygame.draw.rect(pantalla, BLANCO, (ANCHO_PANTALLA//2 - 200, 150, 400, 300), border_radius=15)
        pygame.draw.rect(pantalla, self.ROJO_COCINA, (ANCHO_PANTALLA//2 - 200, 150, 400, 300), 5, border_radius=15)
        
        fuente_titulo = pygame.font.SysFont("arial", 48, bold=True)
        titulo = fuente_titulo.render("HUEVO ROTO", True, self.ROJO_COCINA)
        pantalla.blit(titulo, (ANCHO_PANTALLA//2 - titulo.get_width()//2, 180))
        pos_huevo_x = ANCHO_PANTALLA//2
        pos_huevo_y = 270
        ...
        pygame.draw.circle(pantalla, self.AMARILLO_COCINA, (pos_huevo_x, pos_huevo_y), 20)
        pygame.draw.circle(pantalla, (240, 180, 0), (pos_huevo_x, pos_huevo_y), 20, 2)
        
        fuente_info = pygame.font.SysFont("arial", 24)
        info_nivel = fuente_info.render(f"Llegaste al nivel {nivel_actual}", True, self.MARRON_OSCURO)
        ...
        pygame.draw.rect(pantalla, self.MARRON_CLARO, boton_reiniciar, border_radius=10)
        pygame.draw.rect(pantalla, self.MARRON_OSCURO, boton_reiniciar, 2, border_radius=10)
        
        fuente_boton = pygame.font.SysFont("arial", 22)
        instruccion = fuente_boton.render("Presiona ENTER para volver al menú", True, self.MARRON_OSCURO)
    ...
    def dibujar_juego(self, pantalla, plataformas, obstaculos, powerups, meta, huevo, nivel_actual, tiempo_transcurrido, camara):
        tiempo_actual = pygame.time.get_ticks()
        superficie = pantalla
        if nivel_actual == 3:
            superficie = pygame.Surface((ANCHO_PANTALLA, ALTO_PANTALLA))
        superficie.fill(self.CREMA)
        tamaño_azulejo = 50
        ...
        pygame.draw.rect(superficie, self.MARRON_CLARO, (0, ALTO_PANTALLA - 50, ANCHO_PANTALLA, 50))
        pygame.draw.line(superficie, self.MARRON_OSCURO, (0, ALTO_PANTALLA - 50), (ANCHO_PANTALLA, ALTO_PANTALLA - 50), 3)
        ...
        nombre_nivel = self.obtener_nombre_nivel(nivel_actual)
        texto_nivel = fuente_nivel.render(nombre_nivel, True, self.MARRON_OSCURO)
        ...
        pygame.draw.rect(superficie, self.MARRON_OSCURO, panel_nivel, 2, border_radius=8)
        ...
        pygame.draw.rect(superficie, self.ROJO_COCINA, (10, 40, int((ANCHO_PANTALLA - 20) * progreso), 20), border_radius=5)
        ...
        if meta_pantalla.right >= -50 and meta_pantalla.left <= ANCHO_PANTALLA + 50:
            ...
            texto_meta = fuente_pequeña.render("META", True, self.VERDE_COCINA)
        ...
        for i, plataforma in enumerate(plataformas):
            ...
            if rect_pantalla.right >= -50 and rect_pantalla.left <= ANCHO_PANTALLA + 50:
                ...
                rotacion = 0
                if i % 4 == 0:
                    pygame.draw.rect(superficie, self.MARRON_CLARO, rect_pantalla)
                    pygame.draw.rect(superficie, self.MARRON_OSCURO, rect_pantalla, 2)
                    for j in range(0, rect_pantalla.width, 10):
                        pygame.draw.line(superficie, self.MARRON_OSCURO,
                    ...
                    for j in range(3):
                        ...
                        pygame.draw.circle(superficie, self.MARRON_OSCURO, (x_mancha, y_mancha), radio, 1)
                    ...
                    pygame.draw.rect(cuchillo_surf, self.MARRON_OSCURO,
                    ...
                    pygame.draw.rect(superficie, self.MARRON_CLARO,
                    ...
                    pygame.draw.rect(batidor_surf, self.MARRON_CLARO,
        ...
        for obstaculo in obstaculos:
            ...
            if rect_pantalla.right >= -50 and rect_pantalla.left <= ANCHO_PANTALLA + 50:
                if obstaculo.tipo == "sarten":
                    ...
                    pygame.draw.rect(sarten_surf, self.MARRON_CLARO,
            ...
            if powerup.activo:
                ...
                if rect_pantalla.right >= -50 and rect_pantalla.left <= ANCHO_PANTALLA + 50:
                    if powerup.tipo == "cascara":
                        ...
                        pygame.draw.rect(pantalla, self.MARRON_OSCURO, rect_pantalla)
        ...
        pygame.draw.rect(pantalla, self.MARRON_OSCURO, (5, 70, 180, 100), 2, border_radius=5)
        fuente = pygame.font.SysFont("arial", 16)
        info_grietas = fuente.render(f"Grietas: {huevo.grietas}/3", True, self.MARRON_OSCURO)
        info_nivel = fuente.render(f"Nivel: {nivel_actual}", True, self.MARRON_OSCURO)
        info_tiempo = fuente.render(f"Tiempo: {tiempo_transcurrido}s", True, self.MARRON_OSCURO)
    ...
    def dibujar_victoria(self, pantalla, tiempo_transcurrido):
            ...
            pygame.draw.rect(pantalla, BLANCO, (ANCHO_PANTALLA // 2 - 200, 150, 400, 300), border_radius=15)
            pygame.draw.rect(pantalla, self.VERDE_COCINA, (ANCHO_PANTALLA // 2 - 200, 150, 400, 300), 5, border_radius=15)
            fuente_titulo = pygame.font.SysFont("arial", 48, bold=True)
            titulo = fuente_titulo.render("¡VICTORIA!", True, self.VERDE_COCINA)
            pantalla.blit(titulo, (ANCHO_PANTALLA // 2 - titulo.get_width() // 2, 180))
            ...
            fuente_info = pygame.font.SysFont("arial", 24)
            info_tiempo = fuente_info.render(f"Tiempo: {tiempo_transcurrido} segundos", True, self.MARRON_OSCURO)
    ...
    def dibujar_ingreso_nombre(self, pantalla, nombre_actual="", cursor_visible=True):
            pantalla.fill(self.CREMA)
            tamaño_azulejo = 50
            for y in range(0, ALTO_PANTALLA, tamaño_azulejo):
                for x in range(0, ANCHO_PANTALLA, tamaño_azulejo):
            ...
            pygame.draw.rect(pantalla, self.MARRON_OSCURO, panel_rect, 5, border_radius=15)
            fuente_titulo = pygame.font.SysFont("arial", 36, bold=True)
            titulo = fuente_titulo.render("Ingresa tu nombre", True, self.MARRON_OSCURO)
            pantalla.blit(titulo, (ANCHO_PANTALLA // 2 - titulo.get_width() // 2, 200))
            pygame.draw.line(pantalla, self.MARRON_OSCURO,
            ...
            pygame.draw.rect(pantalla, self.MARRON_OSCURO, caja_texto_rect, 2, border_radius=5)
            ...
            instruccion1 = fuente_instrucciones.render("Usa el teclado para escribir tu nombre", True, self.MARRON_OSCURO)
            instruccion2 = fuente_instrucciones.render("Presiona ENTER para confirmar", True, self.MARRON_OSCURO)
