...
class GestorNiveles:
    def __init__(self):
        self.ANCHO_NIVEL_1 = ANCHO_PANTALLA * 3  
        self.ANCHO_NIVEL_2 = ANCHO_PANTALLA * 4  
        self.ANCHO_NIVEL_3 = ANCHO_PANTALLA * 5  
    ...
    def cargar_nivel(self, numero_nivel):
        ...
        if numero_nivel == 1:
            ancho_nivel = self.ANCHO_NIVEL_1
            ...
            ancho_nivel = self.ANCHO_NIVEL_2
            ...
            ancho_nivel = self.ANCHO_NIVEL_3
